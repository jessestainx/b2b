...
## ATUALIZAÇÃO FASE 1 (2026-07-22) — CONTENÇÃO APLICADA

Ver relatório completo: [`GITHUB_ACTIONS_CONTAINMENT_2026-07-22.md`](./GITHUB_ACTIONS_CONTAINMENT_2026-07-22.md)

- Workflows perigosos/quebrados em **QUARENTENA** (`workflow_call`, sem dispatch).
- Disable API (`disabled_manually`) em remotes com admin para e2e-pr-smoke, nightly, premerge, playwright.
- Var `PLAYWRIGHT_BASE_URL_PR` removida (apontava produção).
- Guard estático: `scripts/ci/guard-no-production.sh` (quality-gates).
- **Fase 2:** NÃO iniciada. Produção permanece **NO-GO**.
...
Ver GITHUB_ACTIONS_CONTAINMENT_2026-07-22.md (call graph, PR, ausência de callers).
