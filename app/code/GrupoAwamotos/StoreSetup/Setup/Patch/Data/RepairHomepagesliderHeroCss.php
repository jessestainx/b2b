...
/**
 * Reaplica backfill do hero após correções de markup Swiper (idempotente).
 */
class RepairHomepagesliderHeroCss implements DataPatchInterface
{
    ...
    {
        return [
            BackfillHomepagesliderSlides::class,
        ];
    }
