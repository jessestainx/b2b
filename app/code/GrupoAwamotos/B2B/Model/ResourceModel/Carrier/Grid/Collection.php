...
namespace GrupoAwamotos\B2B\Model\ResourceModel\Carrier\Grid;

use GrupoAwamotos\B2B\Model\ResourceModel\Carrier;
use GrupoAwamotos\B2B\Model\ResourceModel\Carrier\Collection as CarrierCollection;
...
class Collection extends CarrierCollection implements SearchResultInterface
{
    ...
    public function __construct(
        ...
        string $mainTable = 'grupoawamotos_b2b_carrier',
        string $resourceModel = Carrier::class,
